...
class ContactFormComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 28,
      vars: 8,
      consts: [[1, "flex", "flex-col", "md:flex-row", "w-[90vw]", "md:w-[75vw]", "lg:w-[60vw]", "rounded-xl-", "p-8-", "bg-orange-900", "text-light"], [1, "hidden", "md:flex", "flex-col", "w-full", "md:w-1/2", "py-8", "px-4"], [1, "text-4xl", "md:text-6xl", "leading-none", "font-quicksand", "font-bold", "text-light", "text-left", "w-full"], [1, "w-full", "md:w-1/2-", "h-[16rem]", "md:h-[18rem]", "lg:h-[20rem]", "px-0", "bg-[url('src/assets/images/about0.jpg')]", "bg-no-repeat", "bg-cover", "rounded-md", "bg-center", "bg-opacity-85-", "mt-4"], [1, "text-light", "text-center", "mt-4"], [1, "flex", "flex-col", "w-full", "md:w-1/2", "bg-light_canvas", "p-6", "items-center"], [1, "text-2xl", "font-bold", "text-dark", "text-center", "w-full"], [1, "flex", "flex-col", "space-x-0", "bg-light_canvas", "rounded-lg", "mt-8", "w-full"], [1, "text-xs", "text-dark"], ["type", "text", "placeholder", "Ex: Bernard Gautier", 1, "w-full", "h-12", "rounded-lg", "pl-4", "focus:border-none", "bg-light", "focus:outline-none", "mt-1", "text-dark"], [1, "flex", "flex-col", "space-x-0", "bg-light_canvas", "rounded-lg", "mt-6", "w-full"], ["type", "email", "placeholder", "exemple@exemple.com", 1, "w-full", "h-12", "rounded-lg", "pl-4", "focus:border-none", "bg-light", "focus:outline-none", "mt-1", "text-dark"], ["type", "tel", "placeholder", "Ex: 06007008...", 1, "w-full", "h-12", "rounded-lg", "pl-4", "focus:border-none", "bg-light", "focus:outline-none", "mt-1", "text-dark"], ["type", "email", 1, "w-full", "min-h-36", "rounded-lg", "p-2", "focus:border-none", "bg-light", "focus:outline-none", "mt-1", "text-dark"], [3, "text", "icon", "text_size", "text_color", "visibility", "icon_color", "background", "radius", "link", "bd", "click"]],
